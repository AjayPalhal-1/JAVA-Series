...
public class DatabaseConncetivity {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// for oracle and mysql its will differ:
...
//		    Step 5 Process Results: Iterate through the result set to process the data.
			...
			// resultset does not conatains the actual data
			...
			// Step 6 : Close Resources: Always close the connection, statement, and result set
			// to free resources.
